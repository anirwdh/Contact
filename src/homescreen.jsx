...
import oneVideo from './assets/one.mp4';
    ...
    <div id="contact" style={{ 
            ...
            <div className="form-row" style={{ display: 'flex', gap: 'clamp(0.75rem, 1.5vw, 1rem)', justifyContent: 'space-between' }}>
              ...
              <div style={{ width: 'calc(50% - 0.5rem)' }}>
                ...
                <input 
                  ...
                  style={{
                    width: '90%',
                    padding: 'clamp(0.6rem, 1.3vw, 0.75rem)',
                    backgroundColor: 'rgba(255, 255, 255, 0.05)',
                    border: '1px solid rgba(255, 255, 255, 0.2)',
                    borderRadius: '0.5rem',
                    color: '#ffffff',
      ...
      <style jsx>{`
        ...
        @media (max-width: 320px) {
          .contact-container {
            padding: clamp(0.4rem, 1.2vw, 0.75rem) !important;
            gap: clamp(0.4rem, 1.2vw, 0.75rem) !important;
          }
          
          .contact-info h1 {
            font-size: clamp(1rem, 2vw, 1.3rem) !important;
            margin-bottom: clamp(0.4rem, 1.2vw, 0.75rem) !important;
          }
        ...
        /* Ensure full-screen layout on all devices */
        #contact {
